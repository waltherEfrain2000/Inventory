                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-md-6 d-flex justify-content-end">
                                ...
                                <a class="btn btn-shadow btn-primary" tabindex="0" aria-controls="custom-btn" id="nuevocliente"><span>Agregar cliente <i class="fas fa-user-plus"></i></span></a>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="tabla_clientes" class="table table-striped table-hover table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Nombre</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
                ...
                <form id="addCostomerForm">
                    <div class="row">
                        <div class="mb-3 col-sm-6">
                            <label for="nombre" class="col-form-label pt-0">Cliente:</label>
                        ...
                        <!-- <div class="mb-3 col-sm-6">
                            <label for="precio" class="col-form-label pt-0">Precio de venta:</label>
                            <input type="text" class="form-control" id="precio" name="precio" required />
                        </div> -->
                        <div class=" mb-3 col-sm-6">
                            <label for="precio" id="labelprecio" class="col-form-label pt-0">Precio de venta:</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary" id="btnguardar">Registrar cliente</button>
            </div>
        </div>
    </div>
</div>