                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span class="titulo"></span></li>
                            </ol>
                        </nav>
                    </div>
                    <div class="card-body">
                        <form id="formVehiculo">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" min="0" step="1" class="form-control"
                                            ...
                                            placeholder="Ingrese el kilometraje" aria-describedby="basic-addon2" disabled>
                                ...
                                <div class="mb-2 col-md-12 d-flex justify-content-center" id="divSave">
