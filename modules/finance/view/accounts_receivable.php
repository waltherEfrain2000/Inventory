                    ...
                    <div class="card-header">
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-md-6 d-flex justify-content-end">
                                <a class="btn btn-shadow btn-success" tabindex="0" aria-controls="custom-btn" href="?module=ar_details">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            ...
                            <table class="table table-hover table-bordered nowrap" id="cuentasPorCobrarTabla">
                                <thead>
                                    <tr class="text-center">
                                        <th>ID</th>
                                        <th>Cliente</th>
                                        <th>No. de Documetno</th>
