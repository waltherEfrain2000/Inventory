...
function layout_change(layout) {
  ...
  if (layout === 'dark') {
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', './dist/assets/images/logo-white.svg');
    updateLogo('.navbar-brand .logo-lg', './dist/assets/images/logo-white.svg');
    updateLogo('.auth-main.v1 .auth-sidefooter img', './dist/assets/images/logo-white.svg');
    updateLogo('.footer-top .footer-logo', './dist/assets/images/logo-white.svg');
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', './dist/assets/images/logo.png');
    updateLogo('.navbar-brand .logo-lg', './dist/assets/images/logo.png');
    updateLogo('.auth-main.v1 .auth-sidefooter img', './dist/assets/images/logo.png');
    updateLogo('.footer-top .footer-logo', './dist/assets/images/logo.png');
